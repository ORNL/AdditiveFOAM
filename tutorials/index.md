...
The tutorials document case-specific inputs, commands, and outputs. Model equations and dictionary entries are defined in the [User Guide]({{ '/docs/' | relative_url }}).

| Tutorial | Material | Scope |
|---|---|---|
...
| [Heat-source calibration]({{ '/tutorials/heat-source-calibration/' | relative_url }}) | SS316L | Bayesian calibration using deterministic posterior quadrature |
...
The heat-source calibration tutorial runs a campaign of trial cases. `calibrateHeatSource` extracts liquidus melt-pool depths, fits the projected-source relation, and writes the results and report.
