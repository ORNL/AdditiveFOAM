...
## Source install
[![OpenFOAM-10](https://img.shields.io/badge/OpenFOAM-10-blue.svg)](https://github.com/OpenFOAM/OpenFOAM-10) and the corresponding [![ThirdParty-10](https://img.shields.io/badge/ThirdParty-10-blue.svg)](https://github.com/OpenFOAM/ThirdParty-10) can be compiled from source code following the steps provided in the [OpenFOAM Foundation Documentation](https://openfoam.org/download/archive/page/2/).
...
1. Clone the AdditiveFOAM repository into the OpenFOAM project installation directory `WM_PROJECT_USER_DIR`:
   ...
   ```
2. Build the `additiveFoam` executable and libraries:
   ```bash
   cd $WM_PROJECT_USER_DIR/AdditiveFOAM
   ./Allwmake
   ```
